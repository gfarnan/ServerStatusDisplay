...
environments {
    development {
		...
		statusFile.use="/var/opt/serverstatus/hostdetails.csv"
    }
    production {
...
log4j = {
	appenders {
		...
		file name: "fileLog", file: "/var/opt/serverstatus/myApp.log"
	}
	...
	info 'grails.app.service.org.grails.plugin.resource',
